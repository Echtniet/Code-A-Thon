...
<body>
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <div class="row well">
                <div class="col-lg-2">
                    <img class="img-circle" src="images/BobbyB.png" alt="profile" style="max-height:125px;">
                </div>
                <div class="col-lg-8">
                    <h1>Bobby Bearcat <b>#BobbyBBalling</b></h1>
                    <h5>Phone:</h5>
                    <h5>Email:</h5>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 w3-center">
                    <embed src="bobbybearcat.pdf" width="80%" height="700px" />
                </div>
            </div>
